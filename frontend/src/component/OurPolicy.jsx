...
function OurPolicy() {
  return (
    <div className="w-full py-16 flex flex-col items-center justify-start bg-gradient-to-r from-[#fdfcfb] to-[#e2d1c3]">
      ...
      <div className="flex flex-wrap items-center justify-center gap-12 md:gap-20">
        ...
        {/* Card 1 */}
        <div className="w-[300px] p-6 bg-white rounded-2xl shadow-xl flex flex-col items-center gap-4 hover:scale-[1.03] transition">
