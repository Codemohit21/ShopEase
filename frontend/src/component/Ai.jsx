...
window.speechSynthesis.speak(utterence)
 ...
 if(transcript.toLowerCase().includes("search") && transcript.toLowerCase().includes("open") && !showSearch){
     ...
     else if(transcript.toLowerCase().includes("product") || transcript.toLowerCase().includes("products") || transcript.toLowerCase().includes("all product") || transcript.toLowerCase().includes("products")){
