...
function About() {
  return (
    <div className='w-[99vw] min-h-[100vh] flex items-center justify-center flex-col 
                    bg-gradient-to-br from-[#fdfcfb] via-[#f5e0d3] to-[#e2d1c3] 
                    gap-[50px] pt-[80px]'>
      ...
      <div className='w-full flex items-center justify-center flex-col lg:flex-row gap-10 px-5'>
        ...
        {/* Text */}
        <div className='lg:w-[50%] w-[90%] flex flex-col gap-5 text-gray-800'>
          <p className='lg:w-[90%] text-[14px] md:text-[16px] leading-relaxed'>
            Shopease was born for smart, seamless shopping—created to deliver quality products, trending styles, and everyday essentials in one place. With reliable service, fast delivery, and great value, Shopease makes your online shopping experience simple, satisfying, and stress-free.
          </p>
          <p className='lg:w-[90%] text-[14px] md:text-[16px] leading-relaxed'>
          ...
          <h2 className='text-lg md:text-xl font-bold text-gray-900 mt-2'>Our Mission</h2>
          <p className='lg:w-[90%] text-[14px] md:text-[16px] leading-relaxed'>
            Our mission is to redefine online shopping by delivering quality, affordability, and convenience. Shopease connects customers with trusted products and brands, offering a seamless, customer-focused experience that saves time, adds value, and fits every lifestyle and need.
          </p>
        </div>
      </div>
      ...
      <div className='w-full flex flex-col items-center gap-[20px] mt-10'>
        ...
        <div className='w-[90%] flex items-center justify-center lg:flex-row flex-col gap-6 py-6'>
          ...
          <div className='lg:w-[30%] w-[90%] h-[220px] bg-gradient-to-tr from-[#ffffff] to-[#f7efe9] 
                          border border-gray-200 rounded-xl shadow-md flex flex-col 
                          items-center justify-center gap-4 px-6 py-4 text-center hover:shadow-lg transition-all'>
            <b className='text-lg font-semibold text-orange-600'>Quality Assurance</b>
          ...
          <div className='lg:w-[30%] w-[90%] h-[220px] bg-gradient-to-tr from-[#ffffff] to-[#f7efe9] 
                          border border-gray-200 rounded-xl shadow-md flex flex-col 
                          items-center justify-center gap-4 px-6 py-4 text-center hover:shadow-lg transition-all'>
            <b className='text-lg font-semibold text-orange-600'>Convenience</b>
            <p className='text-gray-700 text-sm'>
          ...
          <div className='lg:w-[30%] w-[90%] h-[220px] bg-gradient-to-tr from-[#ffffff] to-[#f7efe9] 
                          border border-gray-200 rounded-xl shadow-md flex flex-col 
                          items-center justify-center gap-4 px-6 py-4 text-center hover:shadow-lg transition-all'>
            <b className='text-lg font-semibold text-orange-600'>Exceptional Service</b>
            <p className='text-gray-700 text-sm'>
